                            ...
                            <ul class="notifications-container">
                                <li>
                                    <a href="" class="notification-item">
                                        <div class="img-col">
                                            <div class="img"
                                                 style="background-image: url('../../assets/img/faces/3.jpg')"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
                                ...
                                <li>
                                    <a href="" class="notification-item">
                                        <div class="img-col">
                                            <div class="img"
                                                 style="background-image: url('../../assets/img/faces/5.jpg')"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
                                ...
                                <li>
                                    <a href="" class="notification-item">
                                        <div class="img-col">
                                            <div class="img"
                                                 style="background-image: url('../../assets/img/faces/8.jpg')"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
